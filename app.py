...
def generate_invoice_pdf(invoice):
    ...
    if business:
        ...
        company_info = "<font size=16><b>FAJAR MANDIRI FOTOCOPY</b></font><br/>"
        company_info += "KP Jl. Pasir Wangi, RT.01/RW.11, Gudangkahuripan<br/>"
        company_info += "Kec. Lembang, Kab. Bandung Barat, Jawa Barat 40391<br/>"
        company_info += "Telp: (+62) 81804411937<br/>"
        company_info += "Website: fajarmandiri.store"
